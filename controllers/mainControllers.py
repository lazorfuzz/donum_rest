...
class OrganizationList(Resource):
  def get(self):
    ...
    orgs_list = list(map(lambda o: {'name': o.name, 'address': o.address, 'phone_number': o.phone_number, 'donations': o.donations}, orgs))
    return orgs_list
  ...
  def post(self):
    ...
    try:
      ...
      organization = Organization(name=args['name'], phone_number=args['phone_number'], address=args['address'], donations=args['donations'])
...
class OrganizationController(Resource):
  def get(self, org_id):
    ...
    return {'id': org.id, 'name': org.name, 'address': org.address, 'phone_number': org.phone_number, 'donations': org.donations}
